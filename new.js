...
const displayMenuItems = (menuItems)=>{
    //iterate and display item
  let displayMenu = menuItems.map((item)=>{
    return ` <article class="menu-item">
    <img src=${item.img} alt=${item.title} alt='photo'>
    <div class="item-info">
        <header>
            <h4>${item.title}</h4>
  ...
  //display the item in section center
